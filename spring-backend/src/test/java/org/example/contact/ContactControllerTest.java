...
class ContactControllerTest extends ControllerSuiteUtil {
    ...
    private final ContactDetails validRecord = new ContactDetails(0L, 1L, "Tom", "Smith", "ts@example.com", "079678234", List.of(), List.of());
...
//        when
    ...
    void whenPostEmptyName_thenReturn400() throws Exception {
        //given
        objectMapper = new ObjectMapper();
        ContactDetails requestBody = new ContactDetails(0L, 1L, null, "Smith", "ts@example.com", "079678234", List.of(), List.of());
    ...
    void whenPostInvalidEmail_thenReturn400() throws Exception {
        //given
        objectMapper = new ObjectMapper();
        ContactDetails requestBody = new ContactDetails(0L, 1L, "Tom", "Smith", "tsexample.com", "079678234", List.of(), List.of());
    ...
    void whenPostInvalidPhoneNo_thenReturn400() throws Exception {
        //given
        objectMapper = new ObjectMapper();
        ContactDetails requestBody = new ContactDetails(0L, 1L, "Tom", "Smith", "tsexample.com", "NaN", List.of(), List.of());
    ...
    void whenPostSameMailTwiceForDifferentClient_thenReturn422() throws Exception {
        ...
        objectMapper = new ObjectMapper();
        ContactDetails requestBody = validRecord;
        ContactDetails secondAccBody = new ContactDetails(99L, 1L, "Different", "Usern", "ts@example.com", "074978234", List.of(), List.of());
